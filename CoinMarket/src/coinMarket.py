...
from vnpy.trader.gateway import binanceGateway #,bitmexGateway,huobiGateway,bitfinexGateway
    ...
    def threadDataFanout(self):
        ...
        while self.active:
            try:
                ...
                key_name = CoinMarketSymbolTickFormat.format(symbol=tick.vtSymbol)
