...
class Strategy(object):
    ...
    def getPosition(self,code='',strategy_id='' , direction = base.Constants.Buy):
        """查询指定 本策略相关的持仓记录"""
        return self.product.trader.getPosition(code,self.name , direction)
    ...
    def buy(self,code,price,num,oc = Constants.Open , msg=''):
        """默认买开,行为 msg 写入日志"""
    ...
    def sell(self,code,price,num,oc = Constants.Open , msg=''):
        """默认卖开"""
